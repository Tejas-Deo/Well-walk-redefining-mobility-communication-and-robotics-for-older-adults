...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Well Walk"
...
class HaultIntentHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("HaultIntent")(handler_input)
    
    def handle(self, handler_input):
        slots = handler_input.request_envelope.request.intent.slots
        commandtype = slots["HAULT"].value
...
class ChargingDockIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        slots = handler_input.request_envelope.request.intent.slots
        commandtype = slots["CHARGINGDOCK"].value
...
sb.add_request_handler(HaultIntentHandler())
